...
import classes from "../../styles/add_galary.module.sass"
		...
		<div className={classes.Full}>
			...
			<div className={classes.block}>
				...
				<div className={classes.edit_galary} >
					<Image src="/icons/edit.png" width={45} height={45} style={{ cursor: 'pointer' }} alt="Edit"/>
					<Image src="/icons/delete.png" width={34} height={34} style={{ cursor: 'pointer' }} alt="Delete"/>
				</div>
